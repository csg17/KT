...
class Trainer:
    ...
    def train(self):
        ...
        while self.step < total_steps:
            ...
            ######### val iter
            start = 0
            print('Val_gen: ', len(val_gen))
            #while start < len(val_gen): 
            #    val_batches = islice(val_gen, start, start + 100000)
            #    self._test('Validation',val_batches, 100000)
            #    start += 100000
            #    print('start', start)
            #val_batches = islice(val_gen, start, None)
    ...
    def test(self, weight_num):
        ...
        weight_path = '{}{}.pt'.format(ARGS.weight_path, weight_num)
        print('best weight: {}'.format(weight_path))
    ...
    def _test(self, name, batches):
        ...
        print('correct: {}, total: {}'.format(num_corrects, num_total))
        print('[{}]      time: {}, loss: {}, acc: {}, auc: {}'.format(name, training_time, loss, acc, auc))
